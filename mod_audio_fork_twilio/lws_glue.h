...
switch_status_t fork_session_init(switch_core_session_t *session, responseHandler_t responseHandler,
    ...
    char *account_sid, char *call_sid, char *bugname, char* metadata, void **ppUserData);
...
switch_status_t fork_session_dtmf_text(switch_core_session_t *session, char *bugname, const char* text);
